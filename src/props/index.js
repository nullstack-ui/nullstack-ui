...
const handleProp = ({
    ...
    if (!allProps[prop]) {
        console.log('prop does not exist', prop)
        return {
            cssProps: [],
        ...
        if (typeof parsedProps === 'object') {
            for (let parsedProp of Object.keys(parsedProps)) {
                ...
                if (allStates[parsedProp]) {
                    ...
                    if (Object.keys(handledState).length) {
...
export const handleState = ({
    ...
    for (let stateProp in stateProps) {
        ...
        if (propType === 'state') {
            ...
            if (stateProp === '_not') {
                console.log('stateProp', stateProp, stateProps[stateProp])
            }
